...
class EditExporterSubscriptionScreen extends StatefulWidget {
  final String exporterId;
  final String subscriptionId;

  const EditExporterSubscriptionScreen({
    super.key,
  ...
  @override
  State<EditExporterSubscriptionScreen> createState() =>
      _EditExporterSubscriptionScreenState();
}

class _EditExporterSubscriptionScreenState
    extends State<EditExporterSubscriptionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Edit Exporter Subscription"),
      ),
