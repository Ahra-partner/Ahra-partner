            ...
            itemBuilder: (context, index) {
              ...
              return FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  final wholesalerCount =
                      (snapshot.data![3] as QuerySnapshot)
                          .docs.length;

                  final processorCount =
                      (snapshot.data![4] as QuerySnapshot)
                          .docs.length;

                  final exporterCount =
                      (snapshot.data![5] as QuerySnapshot)
                          .docs.length;
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        ...
                        'Wholesalers: $wholesalerCount  |  Processors: $processorCount  |  Exporters: $exporterCount',
                        style: const TextStyle(
                          fontSize: 13,
                        ),
                      ),
