...
class _PartnerDashboardScreenState extends State<PartnerDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        final bool withdrawLocked =
            data['withdrawLocked'] ?? false;

        final bool canWithdraw =
            hasBank && walletBalance > 0 && !withdrawLocked;
  ...
  // ================= STEP-C2A: CREATE WITHDRAW REQUEST =================
  Future<void> _createWithdrawRequest({
    ...
    // 🔒 LOCK further withdraws
    await firestore
        .collection('partners')
        .doc(widget.partnerId)
        .update({'withdrawLocked': true});
  }
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    await _createWithdrawRequest(amount: amount);
