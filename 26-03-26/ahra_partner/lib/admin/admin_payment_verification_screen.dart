...
class AdminPaymentVerificationScreen extends StatelessWidget {
  ...
  print("ENTITY TYPE 👉 ${subRef.parent.parent!.path}");
  print("ENTITY ID 👉 ${subRef.parent.parent!.id}");
    ...
    /// 🔥 DETECT ENTITY TYPE
final fullPath = subRef.parent.parent!.path;
final entityType = fullPath.split('/').first;
print("FULL PATH 👉 $fullPath");
print("FINAL ENTITY 👉 $entityType");
int partnerShare;

if (entityType.toLowerCase() == "farmers") {
