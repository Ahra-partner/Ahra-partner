...
class SubscriptionDetailsScreen extends StatelessWidget {
  ...
  // ✅ MARK AS PAID — FINAL (WITH SUBSCRIPTION TRACKING)
  Future<void> markAsPaid() async {
    ...
    final endDate = DateTime(today.year, today.month + 1, today.day);
    ...
    await FirebaseFirestore.instance.runTransaction((tx) async {
      ...
      // 2️⃣ Update Farmer MAIN Document (🔥 NEW LOGIC)
      tx.set(
        farmerRef,
        {
