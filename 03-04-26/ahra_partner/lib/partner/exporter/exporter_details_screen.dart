...
class ExporterDetailsScreen extends StatelessWidget {
  final Map<String, dynamic> data;

  const ExporterDetailsScreen({
    super.key,
    required this.data,
  });
  ...
  Widget build(BuildContext context) {
    ...
    final List products =
        data['productsExported'] ?? [];

    return Scaffold(
      appBar: AppBar(
        title: const Text('Exporter Details'),
        actions: [
          IconButton(
