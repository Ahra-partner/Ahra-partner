...
class AddWholesalerScreen extends StatefulWidget {
  const AddWholesalerScreen({super.key});

  @override
  State<AddWholesalerScreen> createState() =>
      _AddWholesalerScreenState();
}

class _AddWholesalerScreenState
    extends State<AddWholesalerScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await wholesalerRef.set({
        ...
        'category': 'wholesaler',
        'productsSupplied': finalProducts,
        'status': 'active',
      ...
      _showMsg("Wholesaler Saved Successfully");
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          decoration:
                              InputDecoration(labelText: t.quantity),
                          keyboardType:
