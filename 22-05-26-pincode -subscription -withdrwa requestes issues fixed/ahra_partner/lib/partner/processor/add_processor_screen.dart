...
class AddProcessorScreen extends StatefulWidget {
  const AddProcessorScreen({super.key});

  @override
  State<AddProcessorScreen> createState() =>
      _AddProcessorScreenState();
}

class _AddProcessorScreenState
    extends State<AddProcessorScreen> {
...
Future<String> uploadScreenshot() async {
  ...
  Future<void> _submit() async {
    ...
    if (selectedProducts.isEmpty) {
      _showMsg("Please add at least one service");
      return;
    }
    ...
    try {
      ...
      await processorRef.set({
        ...
        'category': 'processor',
        'productsProcessed': finalProducts,
        'status': 'active',
      ...
      await processorRef
        ...
        'screenshot': screenshotUrl, // ✅ NEW
        'status': 'pending_verification', // ✅ UPDATED
        'createdAt': FieldValue.serverTimestamp(),
      });

      _showMsg("Processor Saved Successfully");
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              _field(_name, t.processorName),
              _field(_mobile, t.mobileNumber, number: true),
              _field(_companyName, t.companyName),
              _pincodeField(t),
_field(_postOffice, t.postOffice),
_field(_mandal, t.mandal),
_field(_district, t.district),
_field(_state, t.state),
