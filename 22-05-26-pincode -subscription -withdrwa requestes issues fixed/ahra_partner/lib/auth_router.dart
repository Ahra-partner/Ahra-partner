...
class AuthRouter extends StatelessWidget {
  ...
  // 🔥 UPDATED FUNCTION (NO _creating)
  Future<void> _createPartnerIfNotExists(String uid) async {
    ...
    final empId = await _generateEmployeeId();
          ...
          builder: (context, adminSnap) {
            ...
            return StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, partnerSnap) {
                ...
                // 🔥 FINAL FIX (WAIT FOR CREATION)
                if (!partnerSnap.hasData ||
                    !partnerSnap.data!.exists) {

                  return FutureBuilder(
                    future: _createPartnerIfNotExists(uid),
