        ...
        child: Column(
          children: [
            ...
            sectionText(
              ...
              "Our vision is to create an inclusive ecosystem where every farmer, regardless of location or scale, has equal access to markets, fair pricing, and growth opportunities.\n\n"

              "We aim to empower buyers with reliable, transparent, and quality sourcing while building a seamless bridge between rural producers and urban markets.\n\n"
            ...
            // 👨‍💼 FOUNDER
sectionTitle("Founders"), sectionText( "Prashanth V & Chundi Srinivasula Reddy\n\n" "Founders & Visionaries of Ahra\n\n" "Driven by a deep passion to transform the agricultural ecosystem, the founders of Ahra are committed to building a direct, transparent bridge between farmers and buyers across India.\n\n" "With strong ground-level understanding of real-world agricultural challenges, they identified the critical gaps in pricing, market access, and supply chain inefficiencies faced by farmers and traders.\n\n" "Through Ahra, they aim to eliminate unnecessary intermediaries, empower farmers with better price realization, and enable buyers with reliable, quality sourcing.\n\n" "Their vision is to leverage technology to create a scalable, trusted, and sustainable agri-business network that connects rural and urban markets seamlessly.\n\n" "By focusing on transparency, accessibility, and long-term value creation, they are working towards building a platform that drives growth for every stakeholder in the agricultural ecosystem.", ),
  ...
  Widget sectionText(String text) {
    return Padding(
      ...
      child: Text(text, textAlign: TextAlign.center, style: const TextStyle(fontSize: 16, height: 1.6)),
    );
  }
