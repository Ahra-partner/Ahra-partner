...
import 'partner_support_screen.dart'; // ✅ NEW IMPORT
    ...
    final items = [
      {
        'title': t.farmers,
        'img':
            'assets/partner_types/farmer.png',
        'screen':
      ...
      },
      {
        'title': 'Retailers',
        'img':
            'assets/partner_types/retailer.png',
        'screen':
      ...
      },
      {
        'title': 'Wholesalers',
        'img':
            'assets/partner_types/wholesaler.png',
        'screen':
            const WholesalerListScreen(),
      },
      {
        'title': 'Processors',
        'img':
            'assets/partner_types/processor.png',
        'screen':
            const ProcessorListScreen(),
      },
      {
        'title': 'Exporters',
        'img':
            'assets/partner_types/exporter.png',
        'screen':
            const ExporterListScreen(),
      },
    ];
