...
class EditWholesalerSubscriptionScreen extends StatefulWidget {
  final String wholesalerId;
  final String subscriptionId;

  const EditWholesalerSubscriptionScreen({
    super.key,
  ...
  @override
  State<EditWholesalerSubscriptionScreen> createState() =>
      _EditWholesalerSubscriptionScreenState();
}

class _EditWholesalerSubscriptionScreenState
    extends State<EditWholesalerSubscriptionScreen> {
  ...
  Future<void> updateSubscription() async {
    ...
    // 🔥 Clean products (remove null / zero qty)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Edit Wholesaler Subscription"),
      ),
