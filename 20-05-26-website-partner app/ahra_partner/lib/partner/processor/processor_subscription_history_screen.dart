...
class ProcessorSubscriptionHistoryScreen extends StatelessWidget {
  ...
  // 🔥 AUTO SYNC TOTAL APPROVED AMOUNT (UPDATED)
  Future<void> _syncTotalPaid() async {
    final subSnap = await FirebaseFirestore.instance
        .collection('processors')
        .doc(processorId)
        .collection('subscriptions')
        .where('status', isEqualTo: 'approved') // ✅ changed
        .get();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Processor Subscription History'),
        actions: [
          IconButton(
