...
class PartnerDashboardV2 extends StatelessWidget {
  ...
  Widget _partnerTypeSelector(BuildContext context, AppStrings t) {
    final types = [
      {'key': 'farmers', 'title': t.farmers, 'img': 'assets/partner_types/farmer.png'},
      {'key': 'retailers', 'title': t.retailers, 'img': 'assets/partner_types/retailer.png'},
      {'key': 'wholesalers', 'title': t.wholesalers, 'img': 'assets/partner_types/wholesaler.png'},
      {'key': 'exporters', 'title': t.exporters, 'img': 'assets/partner_types/exporter.png'},
      {'key': 'processor', 'title': t.foodProcessor, 'img': 'assets/partner_types/processor.png'},
    ];
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, i) {
          final isFarmer = types[i]['key'] == 'farmers';
