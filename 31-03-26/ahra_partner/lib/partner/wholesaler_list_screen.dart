...
import 'wholesaler/add_wholesaler_screen.dart';
import 'wholesaler/wholesaler_subscription_history_screen.dart';
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => const AddWholesalerScreen(),
            ),
          );
        },
      ),
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) =>
                            WholesalerSubscriptionHistoryScreen(
                          wholesalerId: doc.id,
                          wholesalerName:
                              data['name'] ?? '',
                        ),
