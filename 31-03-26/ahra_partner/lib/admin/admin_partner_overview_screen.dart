...
class AdminPartnerOverviewScreen extends StatelessWidget {
  ...
  Future<Map<String, dynamic>> _buildStats(String partnerId) async {
    ...
    // ✅ NEW COLLECTIONS
    final wholesalers = await FirebaseFirestore.instance
        .collection('wholesalers')
        .where('partnerId', isEqualTo: partnerId)
        .get();

    final processors = await FirebaseFirestore.instance
        .collection('processors')
        .where('partnerId', isEqualTo: partnerId)
        .get();

    final exporters = await FirebaseFirestore.instance
    ...
    return {
      ...
      "wholesalers": wholesalers.docs.length,
      "processors": processors.docs.length,
      "exporters": exporters.docs.length,
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _countRow("Total Wholesalers",
                              stats['wholesalers'], Colors.teal),

                          _countRow("Total Processors",
                              stats['processors'], Colors.indigo),

                          _countRow("Total Exporters",
                              stats['exporters'], Colors.brown),
